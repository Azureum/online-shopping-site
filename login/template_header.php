...
<div id="pageheader">
  ...
  <tbody>
    <tr>
      ...
      <div id="logsign"><td><a href="productform.php" class="flatbtn" id="contact">Product Form</a> Welcome     
       <a href="" class="flatbtn" id="button2"><?php $currentuser=get_current_user(); echo "Rachit"; ?> </a><a href="#cart" class="flatbtn" id="button3">Cart</a></td></div>
    </tr>
  </tbody>
</table>
<ul id="menu-bar">
...
<div id="userlogin" style="display:none;height:45%;width:20%;position: absolute;top:0;bottom: 0;left: 0;right: 0;margin: auto;">
    <h1>Login</h1>
		<form id="loginform" name="loginform" method="post" action="storescripts/login.php">
...
<div id="usersignup" style="display:none;height:80%;width:50%;position: absolute;top:0;bottom: 0;left: 0;right: 0;margin: auto;">
		<h1>Signup</h1>
		<form id="signupform" name="signupform" method="post" action="storescripts/signup.php">
